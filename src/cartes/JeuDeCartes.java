...
public class JeuDeCartes {
	private Configuration[] typesDeCartes = { new Configuration(10, new Borne(25)),
			...
			new Configuration(1, new Botte(Type.CREVAISON)), new Configuration(1, new Parade(Type.ACCIDENT)) };
	...
	public String affichageJeuDeCartes() {
		...
		for (int i = 0; i < 19; i++) {
			bld.append(typesDeCartes[i].getNbExemplaires() + " " + typesDeCartes[i].getCarte().toString() + "\n");
		}
		return bld.toString();
	}
